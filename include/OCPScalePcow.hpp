...
public:
    ...
    virtual OCP_DBL SetScaleVal(const OCP_DBL& Swinit, OCP_DBL& Swin, const OCP_DBL& Pcowin, function<OCP_DBL(const OCP_DBL&)> CalPcow) const = 0;
...
public:
    ...
    ScalePcowMethod01(const OCP_DBL& Swco, const OCP_DBL& Pcmax, const OCP_DBL& Pcmin) :
        swco(Swco), maxPcow(Pcmax), minPcow(Pcmin) {};
    OCP_DBL SetScaleVal(const OCP_DBL& Swinit, OCP_DBL& Swin, const OCP_DBL& Pcowin, function<OCP_DBL(const OCP_DBL&)> CalPcow) const override;
...
public:
    ...
    USI Setup(const OCP_DBL& Swco, const OCP_DBL& Pcmax, const OCP_DBL& Pcmin);
    void SetScaleVal(const USI& mIndex, const OCP_USI& bId, OCP_DBL& Swin, const OCP_DBL& Pcowin, function<OCP_DBL(const OCP_DBL&)> CalPcow);
